...
public class EnemyManager : MonoBehaviour
{
    ...
    public Transform parentEnemies; //Nor srive para gestionar quien será el padre de los nuesvos objetos que se crearán, y asi se mantenadrá el orden en al jerarquia
    void Start()
    {
